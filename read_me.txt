...
Vous pouvez utiliser un outil comme FileZilla pour envoyer des fichiers en FTP.
...
Les paramètres de connexion sont les suivants :
    ...
    Identifiant : pxxxxxxx
    Mot de Passe : le même que pour ouverture de session IUT
